...
function createGame(gameEngine, gameMenu, gameState) {
    ...
    var robotPortraitLeft = new Portrait(ctx, AM.getAsset("./img/robotportraitleft.png"), ctx.canvas.width - 190, 21);
    robotPortraitLeft.width = 100;
    robotPortraitLeft.height = 100;
