...
Wolf.prototype.draw = function() {
    if (this.animationState === "idleRight") {
        ...
        this.animationIdleLeft.drawFrame(this.game.clockTick, this.ctx, this.canvasX, this.canvasY);
    } else if (this.animationState === "walkLeft") {
        this.animationWalkLeft.drawFrame(this.game.clockTick, this.ctx, this.canvasX, this.canvasY);
    } else if (this.animationState === "jumpLeft") {
        this.animationIdleLeft.drawFrame(this.game.clockTick, this.ctx, this.canvasX, this.canvasY);
    } else if (this.animationState === "attackLeft") {
        this.animationAttackLeft.drawFrame(this.game.clockTick, this.ctx, this.canvasX - 50, this.canvasY);
    }
}

Wolf.prototype.update = function() {
    var gameEngine = this.game;
    this.currChar = this.game.getCurrentCharacter();
    this.canvasX = this.currChar.canvasX;
    this.canvasY = this.currChar.canvasY;
    this.x = this.currChar.x;
    this.y = this.currChar.y;
    var entityArr = this.game.entities;
    ...
    if (!enemyInRange) {
        this.animationState = this.currChar.animationState;
        this.attacking = false;
        this.direction = this.currChar.direction;
    }

    if (this.currChar.animationState === "attackLeft" && !enemyInRange) {
        this.animationState = "idleLeft";
        this.attacking = false;
        this.direction = "left";
    } else if (this.currChar.animationState === "attackRight" && !enemyInRange) {
        this.animationState = "idleRight";
        this.attacking = false;
        this.direction = "right";
    } else if (this.currChar.animationState === "attackRightUp" && !enemyInRange) {
        this.animationState = "idleRight";
        this.attacking = false;
        this.direction = "right";
    }    
